            ...
            <div class="sm:flex sm:items-start">
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                ...
                <div class="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    <label for="day" class="block text-sm font-medium text-gray-700">Lesson Day</label>
                    <select 
                      id="day" 
                      v-model="form.day" 
                      required
                  ...
                  <div>
                    <label for="time" class="block text-sm font-medium text-gray-700">Lesson Time</label>
                    <input 
                      type="time" 
                      id="time" 
                      v-model="form.time" 
...
const { addStudentModalOpen } = storeToRefs(uiStore);
...
const isOpen = computed(() => addStudentModalOpen.value);

function closeModal() {
  uiStore.setAddStudentModalOpen(false);
  resetForm();
}
